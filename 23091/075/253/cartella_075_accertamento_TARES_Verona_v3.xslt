	...
	<xsl:template match="/">
		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			<fo:layout-master-set>
				<fo:simple-page-master margin-top="1cm"
			...
			<fo:page-sequence master-reference="first"
				...
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:table keep-together="always" border-width="0mm"
						border-color="white" table-layout="fixed" space-before="-0.6cm">
						...
						<fo:table-body>
							<fo:table-row>
								<fo:table-cell text-align="left" vertical-align="left">
								...
								<fo:table-cell text-align="left" vertical-align="left">
									<fo:block />
									<fo:block content-height="1cm" font-size="6.5pt"
										space-before="0.3cm" start-indent="1cm">
										<fo:inline font-weight="bold">in caso di mancato recapito
											restituire a:</fo:inline>
									</fo:block>
									<fo:block content-height="1cm" font-size="6.5pt"
										start-indent="1cm">
										SOLORI SPA
								...
								<fo:table-cell text-align="center" vertical-align="center">
									<fo:block />
									<fo:block content-height="0.90cm" space-before="0.5cm"></fo:block>
								</fo:table-cell>
								<fo:table-cell text-align="center" vertical-align="center">
									<fo:block content-height="1.2cm">
					...
					<fo:block color="#FFFFFF" font-size="2pt">.</fo:block>
			<!--		<xsl:if
					...
					<fo:table keep-together="always" border-width="0mm"
						border-color="white" table-layout="fixed" space-before="-0.85cm">
						<fo:table-column column-width="9cm" />
						...
						<fo:table-body>
							...
							<fo:table-row height="3cm">
								...
								<fo:table-cell display-align="top" text-align="left"
									padding="2pt">
									<!-- Manca il codice nell'XML nuovo -->
									<!-- <fo:block font-family="Arial" font-size="6pt" start-indent="1cm"> 
										<xsl:value-of select="/documento/@numero-lotto" /> </fo:block> -->

									<fo:block font-family="Arial" font-size="6pt" color="#FFFFFF">
										.
									</fo:block>
					...
					<fo:block font-family="Arial" font-size="8pt" color="#000000"
						text-align="justify" space-before="0.1cm">
						<xsl:text>Il ricorso contro il presente atto(artt. 18 e 19 D. Lgs 31.12 1992, n. 546)  è proposto avanti alla Commissione Tributaria Provinciale di Verona, Via Sommacampagna, 63H – Verona, entro 60 (sessanta) giorni, a pena di inammissibilità, dalla data di notificazione dello stesso. Il ricorso, intestato alla predetta Commissione, va presentato al Comune attraverso:</xsl:text>
					</fo:block>
					<fo:block font-family="Arial" font-size="8pt" color="#000000"
						text-align="justify">
						<xsl:text>1. notifica secondo le norme dell'art.137 e seguenti del codice di procedura civile;</xsl:text>
					</fo:block>
					<fo:block font-family="Arial" font-size="8pt" color="#000000"
						text-align="justify">
						<xsl:text>2. spedizione mediante raccomandata A/R in plico senza busta (il ricorso va piegato con lo scritto all'interno, spillato e all'esterno va indicato: "al Comune di Verona - Via Adigetto, 10 - 37121 VERONA");</xsl:text>
					</fo:block>
					<fo:block font-family="Arial" font-size="8pt" color="#000000"
						text-align="justify">
						<xsl:text>3. consegna diretta all'impiegato addetto presso la segreteria della Direzione Fiscalità Contenzioso Tributario (Via Adigetto, 10 - 4 piano stanza n. 5) che rilascerà ricevuta.</xsl:text>
					</fo:block>
					<fo:block font-family="Arial" font-size="8pt" color="#000000"
						text-align="justify">
						<xsl:text>Tale ricorso, purché la controversia abbia valore inferiore a € 20.000,00 (art.12 c.2 ),  produce gli effetti di un reclamo (ricorso-reclamo). Lo stesso può contenere una proposta di mediazione con rideterminazione dell’ammontare della pretesa (art. 17 bis). Il ricorso-reclamo non è procedibile per 90 gg dalla notifica al Comune, termine entro il quale deve essere conclusa la procedura del ricorso-reclamo. Se il reclamo si conclude negativamente, il ricorrente entro 30 gg, </xsl:text>
						<fo:inline font-weight="bold">successivi ai 90 gg dalla
							notifica del ricorso al Comune</fo:inline>
						<xsl:text>, deve depositare, a pena di inammissibilità, presso la segreteria della Commissione Tributaria Provinciale l’originale del ricorso notificato o la copia conforme del ricorso spedito per posta o consegnato a mano (nel qual caso sulla copia stessa il ricorrente dovrà apporre e sottoscrivere la dicitura “copia conforme all'originale”), ai sensi dell’art. 22 del D.Lgs citato.</xsl:text>
					</fo:block>
					<fo:block font-family="Arial" font-size="8pt" color="#000000"
						text-align="justify">
