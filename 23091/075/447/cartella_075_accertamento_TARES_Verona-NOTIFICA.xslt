	...
	<xsl:template match="/">
		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			<fo:layout-master-set>
				<xsl:choose>
					<xsl:when test="/Cartella/Postalizzazione/TipoPostalizzazione = '003'">

						<fo:simple-page-master master-name="first"
							margin-right="1.2cm" auto-adjust-regions="true" margin-left="1.2cm"
							margin-bottom="1cm" margin-top="1cm" page-width="21cm"
							page-height="29.7cm">
							<fo:region-body margin-top="0.5cm" margin-bottom="1.5cm"
								margin-right="0cm" />
							<fo:region-before extent="10cm" region-name="header-primo" />
							<fo:region-after extent="0.3cm" region-name="footer" />
							<fo:region-end reference-orientation="90" extent="0.6cm" />
						</fo:simple-page-master>
						<fo:simple-page-master master-name="others"
							auto-adjust-regions="true" margin-right="1.2cm" margin-left="1.2cm"
							margin-bottom="1cm" margin-top="1cm" page-width="21cm"
							page-height="29.7cm">
							<fo:region-body margin-top="0cm" margin-bottom="1.5cm"
								margin-right="0cm" />
							<fo:region-before extent="0cm" region-name="header-secondo" />
							<fo:region-after extent="0.3cm" region-name="footer" />
							<fo:region-end reference-orientation="90" extent="0.6cm" />
						</fo:simple-page-master>
					</xsl:when>
					<xsl:when
						test="/Cartella/Postalizzazione/TipoPostalizzazione = '004' or 
					/Cartella/Postalizzazione/TipoPostalizzazione = '002' or
					/Cartella/Postalizzazione/TipoPostalizzazione = '007'">
			...
			<fo:page-sequence master-reference="document"
				...
				<fo:static-content flow-name="header-primo">
				...
				<fo:flow flow-name="xsl-region-body">
					...
					<xsl:choose>
						<xsl:when test="/Cartella/Postalizzazione/TipoPostalizzazione = '003'">
							<fo:block start-indent="0.6cm" space-before="-1.35cm"
								content-height="9.5cm">
								<fo:external-graphic content-height="9.5cm"
									src="file:gst03/RS/images/RelataMessoSoloriNexive.jpg" />
							</fo:block>

							<fo:table keep-together="always" border-width="0mm"
								border-color="white" table-layout="fixed" width="100%"
								space-before="1.3cm">
								...
								<fo:table-body>
									<fo:table-row>
										...
										<fo:table-cell display-align="center"
											...
											<fo:block content-width="3.3cm">
												<fo:external-graphic content-width="3.3cm"
													src="file:gst03/RS/images/solori.jpg" />
											</fo:block>
										...
										<fo:table-cell display-align="center"
											...
											<fo:block font-family="Arial" 
												...
												<xsl:value-of
													select="/Cartella/Postalizzazione/EtichettaDestinatario/Destinatario" />
											</fo:block>
											<xsl:if
												test="/Cartella/Postalizzazione/EtichettaDestinatario/InfoDestinatario != ''">
												<fo:block font-family="Arial" font-size="10pt"
													start-indent="0.8cm">
													<xsl:value-of
														select="/Cartella/Postalizzazione/EtichettaDestinatario/InfoDestinatario" />
												</fo:block>
											</xsl:if>
											<xsl:if
												test="/Cartella/Postalizzazione/EtichettaDestinatario/Edificio != ''">
												<fo:block font-family="Arial" font-size="10pt"
													start-indent="0.8cm">
													<xsl:value-of
														select="/Cartella/Postalizzazione/EtichettaDestinatario/Edificio" />
												</fo:block>
											</xsl:if>
											<fo:block font-family="Arial" font-size="10pt"
												start-indent="0.8cm">
												<xsl:value-of
													select="/Cartella/Postalizzazione/EtichettaDestinatario/Indirizzo" />
											</fo:block>
											<fo:block font-family="Arial" font-size="10pt"
												start-indent="0.8cm">
												<xsl:value-of
													select="/Cartella/Postalizzazione/EtichettaDestinatario/Localita" />
											</fo:block>
											<xsl:if
												test="/Cartella/Postalizzazione/EtichettaDestinatario/StatoEstero != ''">
												<fo:block font-family="Arial" font-size="10pt"
													start-indent="0.8cm">
													<xsl:value-of
														select="/Cartella/Postalizzazione/EtichettaDestinatario/StatoEstero" />
												</fo:block>
											</xsl:if>
										</fo:table-cell>
									</fo:table-row>
							...
							<fo:table keep-together="always" border-width="0mm"
								...
								<fo:table-body>
									<fo:table-row>
										...
										<fo:table-cell display-align="center"
											text-align="center" vertical-align="center">
											<fo:block content-height="1.84cm">
												<fo:external-graphic content-height="1.84cm"
													src="file:gst03/RS/images/logoComuneVerona.jpg" />
											</fo:block>
										</fo:table-cell>
										...
										<fo:table-cell display-align="center"
											...
											<fo:block font-family="Arial" space-before="2pt"
												...
												<xsl:choose>
													<xsl:when
														test="/Cartella/SoggettoIntestatario/PersonaFisica/DataDecesso!=''">
														<xsl:choose>
															<xsl:when
																test="string-length(concat('EREDI ',/Cartella/SoggettoIntestatario/PersonaFisica/Cognome, ' ', /Cartella/SoggettoIntestatario/PersonaFisica/Nome)) &gt; 31">
																<xsl:value-of
																	select="substring(concat('EREDI ',/Cartella/SoggettoIntestatario/PersonaFisica/Cognome, ' ', /Cartella/SoggettoIntestatario/PersonaFisica/Nome),0,31)" />
															</xsl:when>
															<xsl:otherwise>
																<xsl:value-of
																	select="concat('EREDI ',/Cartella/SoggettoIntestatario/PersonaFisica/Cognome, ' ', /Cartella/SoggettoIntestatario/PersonaFisica/Nome)" />
															</xsl:otherwise>
														</xsl:choose>
													</xsl:when>
													<xsl:when test="/Cartella/SoggettoIntestatario/PersonaFisica">
														<xsl:choose>
															<xsl:when
																test="string-length(concat(/Cartella/SoggettoIntestatario/PersonaFisica/Cognome, ' ', /Cartella/SoggettoIntestatario/PersonaFisica/Nome)) &gt; 31">
																<xsl:value-of
																	select="substring(concat(/Cartella/SoggettoIntestatario/PersonaFisica/Cognome, ' ', /Cartella/SoggettoIntestatario/PersonaFisica/Nome),0,31)" />
															</xsl:when>
															<xsl:otherwise>
																<xsl:value-of
																	select="concat(/Cartella/SoggettoIntestatario/PersonaFisica/Cognome, ' ', /Cartella/SoggettoIntestatario/PersonaFisica/Nome)" />
															</xsl:otherwise>
														</xsl:choose>
													</xsl:when>
													<xsl:otherwise>
														<xsl:choose>
															<xsl:when
																test="string-length(/Cartella/SoggettoIntestatario/PersonaGiuridica/Denominazione) &gt; 31">
																<xsl:value-of
																	select="substring(/Cartella/SoggettoIntestatario/PersonaGiuridica/Denominazione,0,31)" />
															</xsl:when>
															<xsl:otherwise>
																<xsl:value-of
																	select="/Cartella/SoggettoIntestatario/PersonaGiuridica/Denominazione" />
															</xsl:otherwise>
														</xsl:choose>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
											<xsl:if test="/Cartella/RecapitoDocumento/@Presso!=''">
												<fo:block font-family="Arial" space-before="2pt"
													font-size="10pt">
													C/O
													<xsl:choose>
														<xsl:when
															test="string-length(/Cartella/RecapitoDocumento/@Presso) &gt; 31">
															<xsl:value-of
																select="substring(/Cartella/RecapitoDocumento/@Presso,0,31)" />
														</xsl:when>
														<xsl:otherwise>
															<xsl:value-of select="/Cartella/RecapitoDocumento/@Presso" />
														</xsl:otherwise>
													</xsl:choose>
												</fo:block>
											</xsl:if>
											<fo:block font-family="Arial" space-before="2pt"
												font-size="10pt">
												<xsl:value-of
													select="concat(/Cartella/RecapitoDocumento/Strada, ' ', /Cartella/RecapitoDocumento/NumeroCivico)" />

												<xsl:if
													test="/Cartella/RecapitoDocumento/Esponente!='' and /Cartella/RecapitoDocumento/Esponente!='0'">
													<xsl:text>/</xsl:text>
													<xsl:value-of select="/Cartella/RecapitoDocumento/Esponente" />
												</xsl:if>
											</fo:block>
											...
											<fo:block font-family="Arial" space-before="2pt"
												...
												<xsl:choose>
													<xsl:when
														test="string-length(concat(/Cartella/RecapitoDocumento/Cap, ' ', /Cartella/RecapitoDocumento/Citta, ' ', /Cartella/RecapitoDocumento/Provincia)) &gt; 40">
														<xsl:value-of
															select="substring(concat(/Cartella/RecapitoDocumento/Cap, ' ', /Cartella/RecapitoDocumento/Citta, ' ', /Cartella/RecapitoDocumento/Provincia),0,40)" />
													</xsl:when>
													<xsl:otherwise>
														<xsl:value-of
															select="concat(/Cartella/RecapitoDocumento/Cap, ' ', /Cartella/RecapitoDocumento/Citta, ' ', /Cartella/RecapitoDocumento/Provincia)" />
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
											<fo:block font-family="Arial" space-before="0.5cm"
												font-size="10pt">
												<xsl:choose>
													<xsl:when test="/Cartella/SoggettoIntestatario/PersonaFisica">
														<xsl:value-of
															select="concat('C. F.: ',/Cartella/SoggettoIntestatario/PersonaFisica/CodiceFiscale)" />
													</xsl:when>
													<xsl:otherwise>
														<xsl:value-of
															select="concat('P. I.: ',/Cartella/SoggettoIntestatario/PersonaGiuridica/PartitaIva)" />
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
					...
					/Cartella/Postalizzazione/TipoPostalizzazione = '007'">
							...
							<fo:table keep-together="always" border-width="0mm"
								border-color="black" table-layout="fixed" space-before="0.9cm"
								width="100%">
									...
									<fo:table-row>
										...
										<fo:table-cell display-align="center"
											...
											<fo:block font-family="Arial" font-style="italic"
												font-size="6pt" color="#FFFFFF">.</fo:block>
											<fo:block font-family="Arial" font-style="italic"
												font-size="10pt" color="#FFFFFF">.</fo:block>
											<fo:block font-family="Arial" font-style="italic"
												font-size="10pt" color="#FFFFFF">.</fo:block>
						...
						<xsl:otherwise>
								...
								<fo:table-body>
									<fo:table-row>
										<fo:table-cell display-align="center"
											...
											<fo:block content-height="1.3cm">
												<fo:external-graphic content-height="1.3cm"
													src="file:gst03/RS/images/solori.jpg" />
											</fo:block>
											<fo:block font-style="italic" font-family="Arial" space-before="1pt" font-size="8pt">Società Locale di Riscossione S.p.a.</fo:block>
		      								<fo:block font-style="italic" font-family="Arial" space-before="1pt" font-size="8pt">Vicolo Volto Cittadella 4, 37122 Verona</fo:block>
							...
							<fo:table keep-together="always" border-width="0mm"
								border-color="black" table-layout="fixed" space-before="2cm"
								width="100%">
								<fo:table-column column-width="8.5cm" />
								<fo:table-column column-width="0.7cm" />
								<fo:table-column column-width="8.8cm" />
				...
				<!--<fo:block font-family="Arial" font-size="8pt" color="#000000"
					...
					<xsl:if test="/Cartella/Postalizzazione/TipoPostalizzazione = '007'">
						<fo:block-container text-align="center"
							font-weight="bold" font-size="10pt" space-after="0.2cm"
							space-before="1.5cm" border="1px solid black">
							<fo:block space-after="0.1cm" space-before="0.1cm">
								<xsl:text>RELAZIONE DI NOTIFICA A MEZZO POSTA</xsl:text>
							</fo:block>
						</fo:block-container>
						<fo:block font-family="Arial" font-size="10pt"
							space-before="0.3mm">
							<xsl:text>Il sottoscritto in qualità di Messo Notificatore dichiara di aver notificato il presente atto a mezzo del servizio postale al destinatario </xsl:text>
							<xsl:choose>
								<xsl:when test="/Cartella/RecapitoDocumento/@Presso != ''">
									<xsl:value-of select="/Cartella/RecapitoDocumento/@Presso" />
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of
										select="/Cartella/RecapitoDocumento/@destinatarioPostale" />
								</xsl:otherwise>
							</xsl:choose>
							<xsl:text>, in piego raccomandato con avviso di ricevimento.</xsl:text>
						</fo:block>
						<fo:table space-before="0.3cm">
							...
							<fo:table-body>
								<fo:table-row>
									...
									<fo:table-cell display-align="center" text-align="center"
										padding="2pt">
										<fo:block>
											<fo:external-graphic src="gst03/RS/images/bianco.gif" />
										</fo:block>
									</fo:table-cell>
									<fo:table-cell>
										<fo:block font-family="Arial" font-size="8pt"
											text-align="center">
											<xsl:text>Firma di chi procede alla notifica</xsl:text>
										</fo:block>
										<fo:block font-family="Arial" font-size="8.5pt"
											space-before="0.1cm" font-weight="bold" text-align="center">
											<xsl:choose>
												<xsl:when test="/Cartella/Informative/Funzionari/Funzionario[Ruolo='Messo Notificatore']">
													<xsl:value-of
														select="/Cartella/Informative/Funzionari/Funzionario[Ruolo='Messo Notificatore']/Cognome" />
												</xsl:when>
												<xsl:otherwise>
													<xsl:text>Rosa Caldarelli</xsl:text>
												</xsl:otherwise>
											</xsl:choose>
										...
										<xsl:choose>
											<xsl:when
												test="/Cartella/Informative/Funzionari/Funzionario[Ruolo='Messo Notificatore']/FirmaAutografa = 'false'">

												<fo:block font-family="Arial" font-size="9pt"
													space-before="0cm" color="#000000" text-align="center">Firma apposta
													con indicazione a stampa art. 3 D.Lgs. 39 del 12.02.1993
												</fo:block>
											</xsl:when>
											<xsl:otherwise>
												<fo:block text-align="center" font-family="Courier"
										...
										<fo:block content-height="1.4cm" text-align="center"
											display-align="center">
											<fo:external-graphic content-height="1cm"
												src="file:gst03/RS/images/firma_Caldarelli.jpg" />
										</fo:block>
