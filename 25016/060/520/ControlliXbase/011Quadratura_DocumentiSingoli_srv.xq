...
($idLotto = "19630") 
 ...
 and
  (
    ...
    ($DIRITTI_DI_NOTIFICA != 2.15 and $DIRITTI_DI_NOTIFICA != 3.90) or
    $DIRITTI_DI_RINOTIFICA != 2.15 or
    $countDiritti != 2 or 
    $countNotifica != 1 or 
    $countRiNotifica != 1 or
    
    count($CognomeFunzionarioResTribPieno) != 1 or
    
    $TipoPostaliz != "002" or
    $sommaImportoDebitoRigaF24 != $TotaleDaVersareEstremiDoc or
    $sommaTotaleDelega != $TotaleDaVersareEstremiDoc 
